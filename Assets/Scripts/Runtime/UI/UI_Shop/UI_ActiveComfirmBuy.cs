...
public class UI_ActiveComfirmBuy : MonoBehaviour
{
    ...
    {
        _quantityBuy++;
        if((_quantityBuy * _itemdata.Price ) > PlayerController.Instance.PlayerStats.Money)
            _quantityBuy = (int)(PlayerController.Instance.PlayerStats.Money / _itemdata.Price);
    ...
    private void ConfirmButton()
    {
        ...
        Shop.Purchare(_itemdata,_quantityBuy);
        Reset();
    }
