...
public class UI_Register : MonoBehaviour,IAnimationUI
{
    ...
    public void OnButtonRegis()
    {
        ...
        string password = _inputPasswork.text;
        string repassword = _inputRePasswork.text;
        string email = _inputEmail.text;
        _registerController.Register(username.Trim() , email.Trim() , password.Trim() , repassword.Trim());
    }
