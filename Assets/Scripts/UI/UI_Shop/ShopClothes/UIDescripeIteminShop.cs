...
public class UIDescripeIteminShop : MonoBehaviour
{
   ...
   {
      if (_shopClothes.PlayerManager == null) return;
      ...
      {
         var clotheset = clothes.itemClothes.HasItem() && clothes.itemClothes.Item.ItemInfor is ClothesItem_SO itemso
            ? itemso
            : null;
         _modelPreViewPlayer.SetClothesPlayer(clothes.type,clotheset );
      }
